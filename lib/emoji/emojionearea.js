...
// see https://github.com/Modernizr/Modernizr/blob/master/feature-detects/storage/localstorage.js
    ...
    function init(self, source, options) {
        ...
        self.emojiTemplate = '<img alt="{alt}" width="20" class="emojione' + (self.sprite ? '-{uni}" src="' + blankImg + '"/>' : 'emoji" src="{img}"/>');
    ...
    EmojioneArea.prototype.setText1 = function (str) {
        var self = this;
        emojioneReady(function () {
            self.editor.html(str);
            self.content = '<p>' + self.editor.html() + '</p>';
            trigger(self, 'change', [self.editor]);
            calcButtonPosition.apply(self);
        });
        return self;
    ...
    EmojioneArea.prototype.getText1 = function () {
